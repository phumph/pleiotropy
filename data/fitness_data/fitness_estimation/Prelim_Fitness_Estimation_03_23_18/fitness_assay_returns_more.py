...
def inferFitness(barcodes,cycleTimes,allReads,outputFolder=None,experimentName=None,neutralBarcodes=None,
    ...
    repFitnessData,used_neuts = inferFitnessAndError(filteredReads,filteredCycleTimes,multNoiseParams,neutralIndices,zCutoff,barcodes)
    ...
    return repFitnessData,used_neuts
...
def inferFitnessAndError(allReads,allCycleTimes,multNoiseParams,neutralIndices,zCutoff,barcodes):
    ...
    for repName in repNames:
        ...
        used_neut_indices = newNeutralIndices
        # Store neutrals
    ...
    return repFitnessData,used_neut_indices
